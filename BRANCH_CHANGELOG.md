...
**当前开发线**：`3.1.7.1`（站点日志 **3.1.7.1**；从 `3.1.7` 拉出继续迭代）。  
...
| **定位** | 相对 `3.1.7` 的后续迭代 |
| **基于** | `3.1.7` |
| **尖端** | 代码已快进合入 `3.1.7`（`a43a125`）；本分支保留，继续日常开发 |
...
| **建议** | 日常开发与新功能提交落此分支 |
| **说明** | `3.1.7.2` 为另一条线（置顶编辑/转模标记/临界推演等），本线 seed **不**写入该版本，避免与 3.1.7 / 3.1.7.1 抢顺序 |
