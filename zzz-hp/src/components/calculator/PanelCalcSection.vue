 ...
 * 过渡：伤害结果区（Teleport 版）已整体移除，script 中该区专用变量暂留待清
 * （统一伤害结果区在 DamageCalcPage 底部，见 docs/specs/panel-affix-flow.svg）。
 * TODO(cleanup): 移除 valueTips / aligned* / selectedEvent* / damageEvent* 等死代码。 */
